...
import cv2
import wandb
from image_preprocessors import apply_canny, apply_morphology, black_and_white  # type: ignore
import matplotlib.pyplot as plt

DATA_PATH = os.path.join(os.path.expanduser("~"), "VisionTransformer", "data")
...
if __name__ == "__main__":
    ...
    def train_sweep():
        with wandb.init() as run:
            ...
            optimizer = optim.AdamW(model.fc2.parameters(), lr=config.learning_rate, weight_decay=0.01)
