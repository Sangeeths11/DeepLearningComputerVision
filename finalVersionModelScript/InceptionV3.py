...
from modules.wandb_integration import SweepOptimizer, log_evaluation, log_image
...
if __name__ == "__main__":
    ...
    optimizer = SweepOptimizer(
        "VisionTransformer", "InceptionV3-Preprocessing", "epoch/val_accuracy"
    )
    ...
    with wandb.init(project="VisionTransformer", config=best_params) as run:
        ...
        run.name = "InceptionV3-Preprocessing"
